    ...
    return(
        <div>
            ...
            <p className='fondoAbout'>
                ...
                <p className='textoAbout'> Te preguntarás, ¿cómo surgió MAD Shop? Pues llegó un día que un alumno del Grado<br/>
                    ...
                    "mainstream". Aparte de la privacidad, otro de los motivos por el que decidió crear MAD Shop fue, para dar un enfoque más<br/>
                    ...
                    investigación, sobre la Tecnología A-Frame, sobre la Tecnología mySQL para el desarrollo de la base de datos, sobre la<br/>
                    Tecnología NodeJS para el desarrollo del BackEnd y, sobre la Tecnología ReactJS para el desarrollo del FrontEnd. También<br/>
                    la edición de fotos con Adobe Photoshop y GIFs.
                    <br/>
                    <br/>
                    Desde MAD Shop, si tenéis inseguridad a la hora de desarrollar un proyecto profesional,<br/>
                    ...
                    <br/>
                    <br/>
                    Así qué, ya sabes, lucha por tus objetivos profesionales y personales y, no dejes que guíen tu vida, ya qué el dueño de ella,
                    ¡ERES TÚ!
                </p>
            </p>
            <br/>
